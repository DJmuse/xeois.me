var Application = {
    ...
    remark: {
        phrases: ['designer <span class="opt">of simple things</span>', 'DJ', 'lover of arts', 'smiling fanatic', 'workaholic', '<span class="opt">dedicated</span> web developer', 'fresh out of witty remarks'],
        count: 0,
        swap: function() {
